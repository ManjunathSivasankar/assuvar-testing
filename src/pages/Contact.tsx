              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="font-roboto text-white/70">+1 (555) 123-4567</p>
                  </div>
                </div>
                ...
                <div className="flex space-x-4">
                  {['facebook', 'twitter', 'instagram', 'linkedin'].map((social) => (
                    <a
                      key={social}
                      href="#"
                      className="w-12 h-12 rounded-full flex items-center justify-center bg-white/5 text-white hover:bg-secondary hover:text-black transition-colors duration-300"
                    >
        ...
        <div className="container mx-auto px-6">
          <div className="animate-section">
            <div className="relative w-full h-[400px] rounded-lg overflow-hidden">
              ...
              <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1494891848038-7bd202a2afeb')] bg-cover bg-center opacity-50" />
